...
const ProductList: React.FC = () => {
  ...
  return (
    <div className="bg-slate-50 dark:bg-black min-h-screen py-6 md:py-16 transition-colors duration-500">
      <div className="max-w-7xl mx-auto px-2 md:px-4">
        ...
        <div className="text-center mb-8 md:mb-16">
            ...
            <h1 className="text-2xl md:text-6xl font-black text-slate-900 dark:text-white mb-2 md:mb-6">منتجات المتجر</h1>
